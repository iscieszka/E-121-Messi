...
void loop() {
  unsigned int sensorleft = readADC(0);
  unsigned int sensorright = readADC(1);
  unsigned int sensorback = readADC(2);
  unsigned int sensorfloor = readADC(3);
  Serial.print("Left: ");
  Serial.print(sensorleft);
  Serial.print("  Right: ");
  Serial.print(sensorright);
  Serial.print(" Back: ");
  Serial.print(sensorback);
  Serial.print(" Top: ");
  Serial.println(sensorfloor);
